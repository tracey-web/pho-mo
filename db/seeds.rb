...
User.create(:email => 'testemail4@gmail.com', :password => 'chicken', :username => 'kristinadelp', :name => 'Kristina Delp', :dob => '2002-08-04', :avatar => 'https://images.unsplash.com/profile-1609522357713-7de8f47be60bimage?dpr=1&auto=format&fit=crop&w=150&h=150&q=60&crop=faces&bg=fff', :bio => 'connecticut cinematographer
